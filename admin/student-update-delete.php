...
<body>
    ...
    <div class="container">
        <h2 class="text-center">Search for Student</h2>
	<div class="row">
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "SELECT * FROM Student WHERE (concat_ws(' ', firstName, lastName) LIKE '%$criteria%')";
        ...
        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            echo "<tr class='results' data-value='$studentID'><td>";
            echo $row['firstName'];
            echo "</td><td>";
            echo $row['lastName'];
            echo "</td><td>";
...
?>
    ...
    $(document).ready(function(){
        $('tr.results').click(function(){
            ...
            window.location.assign('student.php?studentID=' + value);
